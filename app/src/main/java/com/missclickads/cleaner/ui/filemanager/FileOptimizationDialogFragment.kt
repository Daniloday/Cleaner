...
import com.missclickads.cleaner.databinding.DeleteOptimizationFragmentBinding
...
class FileOptimizationDialogFragment  (
    private val text2 : String,
    private val callback : () -> (Unit)

) : DialogFragment() {
    private var _binding: DeleteOptimizationFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DeleteOptimizationFragmentBinding.inflate(inflater, container, false)
